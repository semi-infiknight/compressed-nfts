...
(async () => {
  ...
  */
  ...
  const collectionMetadataV3: CreateMetadataAccountArgsV3 = {
    data: {
      ...
      uri: "blue-magnetic-wallaby-228.mypinata.cloud/ipfs/QmX4yEEUNNLMKJg1bPWiQhXbqSQ61VH191HgFkQbMJEYuW",
  ...
  */
  ...
  const compressedNFTMetadata: MetadataArgs = {
    ...
    uri: "https://backscattering.de/web-boardimage/board.svg?fen=rnbq1bnr/ppppkppp/8/4p3/4P3/8/PPPPKPPP/RNBQ1BNR%20w%20-%20-%202%203&coordinates=true&colors=lichess-blue&size=540&squares=e7&check=e2&check=e7",
    creators: [
      {
        address: payer.publicKey,
        verified: false,
